...
Item {
    ...
    property int itemWidth: 40     // 每個項目寬度
    ...
    Flickable {
            ...
            Repeater {
                ...
                delegate: Item {
                    ...
                    Text {
                        ...
                        // 動態縮放和顏色
                        property real distanceToCenter: Math.abs((index*root.itemWidth) - flick.contentX + flick.width/2 - root.itemWidth/2)
        ...
        onMovementEnded: {
            // 自動對齊到最近項目
            var target = Math.round(contentX / root.itemWidth) * root.itemWidth
            contentX = target
